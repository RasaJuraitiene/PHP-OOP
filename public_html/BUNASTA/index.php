...
<head>
    ...
    <link rel="icon" href="https://bunasta.eu/wp-content/themes/bunasta/favicon.ico" type="image/x-icon"/>
    <link rel="shortcut icon" href="https://bunasta.eu/wp-content/themes/bunasta/favicon.ico" type="image/x-icon"/>
...
<div id="header-wrapper">
    <div id="header" class="container">
        <div id="logo">
            <h1><a href="https://bunasta.eu/en/">BUNASTA</a></h1>
        </div>
        <div id="menu">
            <ul>
                <li class="current_page_item"><a href="#" accesskey="1" title="">About Us</a></li>
                <li><a href="#" accesskey="2" title="">News</a></li>
                <li><a href="#" accesskey="3" title="">Services</a></li>
                <li><a href="#" accesskey="4" title="">Client service centers</a></li>
                <li><a href="#" accesskey="5" title="">Contact us</a></li>
                <li><a href="#" accesskey="5" title="">LT EN RU</a></li>
            </ul>
        </div>
    </div>
</div>
<div id="header-featured">
    <div id="banner-wrapper">
        <div id="banner" class="container">
            <h1 class="main">Main selling point</h1>
            <div class="flex-row">
                <ul class="font-size cards">24/7 <ul>Service</ul></ul><ul class="font-size cards">5 <ul>Countries</ul></ul> <ul class="font-size cards">28<ul>Service Centres</ul></ul><ul class="font-size cards">400<ul>Declarations</ul></ul><ul class="font-size cards">25 M EUR<ul>Guarantees</ul></ul>
            </div>
